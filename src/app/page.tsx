  ...
  <section id='skills'>
    ...
    <div className='highlight skill-stack'>
      <div className='highlight-title-wrapper'>
        <strong>Tools</strong>
        <span className='highlight-subtitle'>
          — Git, GitHub, CI / CD, Linux, Docker, Figma, Chrome Dev Tools, Slack, OOP, Agile Workflow
        </span>
      </div>
    </div>
  </section>
...
const Projects = () => (
  <section id='applications'>
    ...
    <div className='highlight'>
      ...
      <em>Calendar application that enables users to create, view, and manage upcoming events.</em>
      <ul>
        <li>
          Built responsive user interface with <strong>React</strong> to display events in daily,
          weekly, and monthly views.
        </li>
        <li>
          Integrated with <strong>Google Firestore</strong> to ensure events are always up to date
          and sync across all devices.
        </li>
        <li>
          Setup <strong>Custom React Hooks</strong> to handle User Authentication, React Context,
          and
...
const Experience = () => (
  <section id='experience'>
    ...
    <div className='highlight'>
      ...
      <ul>
        <li>
          Conduct 180-minute trainings 3 times per week to enhance players' technical and teamwork
          abilities.
        </li>
        <li>Direct teams of 18 players to maintain focused and productive training sessions.</li>
        <li>
    ...
    <div className='highlight'>
      ...
      <ul>
        ...
        <li>
          Implemented study techniques like Active Recall and Spaced Repetition to improve student
          memory.
        </li>
        <li>
...
const Education = () => (
  <section id='education'>
    ...
    <div className='highlight'>
      <header className='highlight-title-wrapper'>
        <h3 className='highlight-title'>Certificate In CS50 Introduction To Computer Science</h3>
        <span className='highlight-subtitle'>— Harvard University</span>
        <span className='date'>06/2024</span>
      </header>
      <ul>
        <li>
          Mastered key computer science concepts such as abstraction, algorithms, data structures,
          encapsulation, resource management, security, and web development.
        </li>
      </ul>
    </div>
    <div className='highlight'>
